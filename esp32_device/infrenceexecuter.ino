...
// ------------------------------------------------------------
//
// Your model is ~67 KB, but the model itself lives in flash.
// The tensor arena is RAM used by the interpreter.
//
// Start with 64 KB.
// If AllocateTensors() fails, increase this.
//
...
// ------------------------------------------------------------
//
// This intentionally handles the simple text format used by
// your current test sentences.
//
// It:
...
void RunInference(const char* text) {
    ...
    // --------------------------------------------------------
    // Copy tokens into TFLite input tensor
    // --------------------------------------------------------
